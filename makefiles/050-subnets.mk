...
subnets-a:
	...
	aws ec2 create-tags --resources $$(cat tmp.${INSTANCE_FILE}) --region $(REGION_A) \
	   --tags Key=Name,Value=$(SUBNET_A_A_NAME) Key=Project,Value=$(PROJECT_NAME) Key=Rev,Value=$(PROJECT_REV)
	@echo VPC_A_SUBNET_A_ID=$$(cat tmp.${INSTANCE_FILE}) >> ${INSTANCE_FILE}
	...
	aws ec2 create-tags --resources $$(cat tmp.${INSTANCE_FILE}) --region $(REGION_A) \
	   --tags Key=Name,Value=$(SUBNET_A_B_NAME) Key=Project,Value=$(PROJECT_NAME) Key=Rev,Value=$(PROJECT_REV)
	@echo VPC_A_SUBNET_B_ID=$$(cat tmp.${INSTANCE_FILE}) >> ${INSTANCE_FILE}
	...
	aws ec2 create-tags --resources $$(cat tmp.${INSTANCE_FILE}) --region $(REGION_A) \
	   --tags Key=Name,Value=$(SUBNET_A_C_NAME) Key=Project,Value=$(PROJECT_NAME) Key=Rev,Value=$(PROJECT_REV)
	...
	aws ec2 create-tags --resources $$(cat tmp.${INSTANCE_FILE}) \
	  --region $(REGION_A) \
	   --tags Key=Name,Value=$(SUBNET_A_D_NAME) Key=Project,Value=$(PROJECT_NAME) Key=Rev,Value=$(PROJECT_REV)
...
subnets-b:
	...
	aws ec2 create-tags --resources $$(cat tmp.${INSTANCE_FILE}) --region $(REGION_B) \
	   --tags Key=Name,Value=$(SUBNET_B_A_NAME) Key=Project,Value=$(PROJECT_NAME) Key=Rev,Value=$(PROJECT_REV)
	...
	aws ec2 create-tags --resources $$(cat tmp.${INSTANCE_FILE}) --region $(REGION_B) \
	   --tags Key=Name,Value=$(SUBNET_B_B_NAME) Key=Project,Value=$(PROJECT_NAME) Key=Rev,Value=$(PROJECT_REV)
	...
	aws ec2 create-tags --resources $$(cat tmp.${INSTANCE_FILE}) --region $(REGION_B) \
	   --tags Key=Name,Value=$(SUBNET_B_C_NAME) Key=Project,Value=$(PROJECT_NAME) Key=Rev,Value=$(PROJECT_REV)


	aws ec2 create-subnet --vpc-id ${VPC_B_ID} --cidr-block ${VPC_B_SUBNET_D} \
	   --region ${REGION_B} --availability-zone ${ZONE_B_C} --query 'Subnet.SubnetId' --output text> tmp.$(INSTANCE_FILE)
	aws ec2 create-tags --resources $$(cat tmp.${INSTANCE_FILE}) --region $(REGION_B) \
	   --tags Key=Name,Value=$(SUBNET_B_D_NAME) Key=Project,Value=$(PROJECT_NAME) Key=Rev,Value=$(PROJECT_REV)
